    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-100 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center space-y-4">
          ...
          <p className="text-emerald-700 font-medium">Loading train data...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-600 font-medium">Civix</p>
              </div>
            </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border-2 border-emerald-200 rounded-2xl shadow-lg focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 transition-all duration-200 placeholder-emerald-400"
            />
          </div>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-emerald-100">
                {filteredData.map((row, index) => (
                  <tr 
                    key={index} 
                    className="hover:bg-emerald-50 transition-colors duration-150 group"
                  >
                    <td className="px-6 py-4 text-sm font-mono text-emerald-700 font-semibold">
                      {row["train no"]}
                    </td>
                    <td className="px-6 py-4 text-sm font-medium text-gray-800 group-hover:text-emerald-700 transition-colors">
                      {row["train name"]}
                    </td>
