      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-3xl font-bold text-gray-800">Financial Data</h2>
          </div>
          <p className="text-gray-600 text-lg">Comprehensive financial data overview and analysis</p>
        </div>
        ...
        {rows.length > 0 ? (
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-green-100">Total Records: {rows.length}</p>
                </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-200">
                    {Object.keys(rows[0]).map((header, i) => (
                      <th key={i} className="px-6 py-4 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider border-r border-green-100 last:border-r-0 whitespace-nowrap">
                ...
                <tbody className="divide-y divide-green-100">
                  {rows.map((row, i) => (
                    <tr key={i} className="hover:bg-green-50/50 transition-colors duration-200 group">
                      {Object.values(row).map((value, j) => (
                        <td key={j} className="px-6 py-4 text-sm text-gray-800 border-r border-green-50 last:border-r-0 group-hover:border-green-100 transition-colors duration-200">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-green-100 p-12 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Loading Financial Data</h3>
