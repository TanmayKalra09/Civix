    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-green-700 font-medium">Loading school data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="bg-white/80 backdrop-blur-sm border-b border-green-100 ">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-green-600 font-medium">Education Statistics India</p>
            <div className="mt-4 inline-flex items-center px-4 py-2 bg-green-100 rounded-full text-sm text-green-700 font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-green-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-emerald-600">Data Columns</p>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-green-100 overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 border-b border-green-100">
            <h2 className="text-xl font-semibold text-white">Education Data Table</h2>
            <p className="text-green-100 text-sm mt-1">Comprehensive school statistics and metrics</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
                ...
                <tr>
                  {data.length > 0 &&
                    Object.keys(data[0]).map((key, index) => (
                      <th key={index} className="px-6 py-4 text-left text-sm font-semibold text-green-800 border-b border-green-200 whitespace-nowrap">
              ...
              <tbody className="divide-y divide-green-100">
                {data.map((row, i) => (
                  <tr key={i} className="hover:bg-green-50/50 transition-colors duration-200">
                    {Object.values(row).map((value, j) => (
                      <td key={j} className="px-6 py-4 text-sm text-gray-700 whitespace-nowrap border-b border-green-100/50">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-2 flex items-center justify-center space-x-2">
            ...
            <span className="text-green-500 text-xs font-medium">Real-time data visualization</span>
          </div>
        </div>
      </div>
    </div>
