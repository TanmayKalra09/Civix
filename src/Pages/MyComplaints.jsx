      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-end mb-6">
          <select
            ...
            className="px-4 py-2 border rounded-lg text-green-700 dark:text-green-300 bg-white dark:bg-gray-800 border-green-200 dark:border-green-700 focus:outline-none focus:ring-2 focus:ring-green-400"
          >
        ...
        {filteredComplaints.length === 0 ? (
          <div className="text-center py-16">
            <div className="w-24 h-24 mx-auto mb-6 bg-green-100 dark:bg-green-800 rounded-full flex items-center justify-center">
              <svg
                className="w-12 h-12 text-green-500 dark:text-green-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
